...
struct ContentView: View {
    ...
    // Challenges (project 6 - animation)
    @State private var flagSpins = [0.0, 0.0, 0.0]
            ...
            VStack {
                ...
                VStack(spacing: 15) {
                    ...
                    ForEach(0..<3) { number in
                        ...
                        }.rotation3DEffect(.degrees(Double(flagSpins[number])), axis: (x: 0, y: 1, z: 0))
